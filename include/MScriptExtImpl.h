...
#ifndef _M_SCRIPT_EXT_IMPL_H
#define _M_SCRIPT_EXT_IMPL_H

#include <lua.hpp>
#include "MScriptExt.h"


class MScriptExtImpl : public MScriptExt
{
public :
...
public:
    ...
    void parse(const char* script, const char* name, unsigned int size);
